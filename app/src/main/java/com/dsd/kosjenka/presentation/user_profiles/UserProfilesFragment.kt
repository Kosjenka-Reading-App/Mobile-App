...
//        }
    ...
    private fun getProfiles() {
        profilesList = mutableListOf(
            UserProfile(0, "user1", 5.0), UserProfile(1, "user2", 1.0), UserProfile(2, "user3", 2.0)
        )
    ...
    override fun onProfileClick(profile: UserProfile) {
        ...
        findNavController().navigate(
            UserProfilesFragmentDirections.actionUserProfilesFragmentToHomeFragment(profile.profileId)
        )
    }
