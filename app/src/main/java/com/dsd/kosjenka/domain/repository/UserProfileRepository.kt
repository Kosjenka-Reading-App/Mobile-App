...
//        token: String
        ...
        if (netManager.isConnectedToInternet()) remote.getUserProfiles()
...
//        token: String,
        ...
        remote.createUserProfile(userProfile)
    }
...
//         token: String,
        ...
        remote.editUserProfile( userProfile)
    }
...
//        token: String,
        ...
        remote.deleteUserProfile( userProfile)
    }
